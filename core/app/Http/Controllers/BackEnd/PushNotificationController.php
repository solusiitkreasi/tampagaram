...
class PushNotificationController extends Controller
{
  public function settings()
  {
    ...
    return view('backend.push-notification.settings', ['data' => $data]);
  }
  ...
  public function updateSettings(Request $request)
  {
    ...
    if ($request->hasFile('notification_image')) {
      ...
      $imageName = UploadFile::update('./assets/img/', $newImage, $oldImage);
  ...
  {
    return view('backend.push-notification.write-notification');
  }
