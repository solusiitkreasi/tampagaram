            ...
            <div class="col-lg-6 offset-lg-3">
              ...
              >
                ...
                @if ($websiteInfo->theme_version == 'theme_two')
                  <div class="form-group">
                    <div class="thumb-preview" id="thumbPreview1">
                      <img src="{{ asset('assets/img/testimonial_section/' . $testimonialInfo->client_image) }}" alt="client image">
                    </div>
                    <br><br>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="client_name" value="{{ $testimonialInfo->client_name }}">
                ...
                @if ($websiteInfo->theme_version == 'theme_two')
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="client_designation" value="{{ $testimonialInfo->client_designation }}">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control ltr" name="serial_number" value="{{ $testimonialInfo->serial_number }}">
