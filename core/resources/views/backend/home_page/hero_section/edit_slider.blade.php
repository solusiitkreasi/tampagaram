          ...
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <form
                ...
                action="{{ route('admin.home_page.hero.update_slider_info', ['id' => $slider->id]) }}"
                method="POST"
              >
                @csrf
                <div class="form-group">
                  <div class="thumb-preview" id="thumbPreview1">
                    <img src="{{ asset('assets/img/hero_slider/' . $slider->img) }}" alt="...">
                  </div>
                  <br><br>
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="title" placeholder="Enter Slider Title" value="{{ $slider->title }}">
                      @if ($errors->has('title'))
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="subtitle" placeholder="Enter Slider Subtitle" value="{{ $slider->subtitle }}">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="btn_name" placeholder="Enter Slider Button Name" value="{{ $slider->btn_name }}">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="url" class="form-control ltr" name="btn_url" placeholder="Enter Slider Button URL" value="{{ $slider->btn_url }}">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control ltr" name="serial_number" placeholder="Enter Slider Serial Number" value="{{ $slider->serial_number }}">
