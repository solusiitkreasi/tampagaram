        ...
        <div class="card-body pt-5 pb-5">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form
                id="serviceForm"
                action="{{ route('admin.services_management.update_service', ['id' => $service->id]) }}"
                method="POST"
              >
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                          ...
                          <div class="btn-group d-block">
                            ...
                            ><i class="{{ $service->service_icon }}"></i></button>
                            <button
                              type="button"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="serial_number" placeholder="Enter Serial Number" value="{{ $service->serial_number }}" >
                ...
                <div id="accordion" class="mt-3">
                  @foreach ($languages as $language)
                    @php
                      $serviceContent = $language->serviceDetails()
                          ...
                          <div class="row service-content">
                            <div class="col-lg-12">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <textarea
                                  class="form-control summernote" id="{{ $language->code }}_content"
                                  name="{{ $language->code }}_content"
                                  placeholder="Enter Content"
                                  data-height="300"
                                >{{ replaceBaseUrl($content, 'summernote') }}</textarea>
                              </div>
                            </div>
                          </div>
