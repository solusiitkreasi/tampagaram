                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="number" step="0.01" class="form-control" name="rent" placeholder="Enter Room Rent">
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="longitude" placeholder="Enter longitude for map">
                      <p class="text-warning mb-0">Will be used to show in google map.</p>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="version">
                      ...
                      >
                        <div class="version-body">
                          <div class="row">
                            <div class="
                            @if ($websiteInfo->room_category_status == 0)
                            col-lg-12
                            @else
                            col-lg-6
                            @endif">
                                ...
                                <div>
                                  @foreach ($amenities as $amenity)
                                    <div class="d-inline mr-3">
                                      <input type="checkbox" class="mr-1" name="{{ $language->code }}_amenities[]" value="{{ $amenity->id }}">
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <textarea id="{{ $language->code }}DescriptionSummernote" class="form-control summernote" name="{{ $language->code }}_description" placeholder="Enter Description" data-height="300"></textarea>
                              </div>
                            </div>
                          </div>
