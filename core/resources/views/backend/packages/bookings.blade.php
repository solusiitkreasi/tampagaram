        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-6 offset-lg-2">
              <button
                class="btn btn-danger btn-sm float-right d-none bulk-delete mr-2 ml-3 mt-1"
                data-href="{{ route('admin.package_bookings.bulk_delete_booking') }}"
              ><i class="flaticon-interface-5"></i> {{ __('Delete') }}</button>

              <form class="float-right"
                @if (request()->routeIs('admin.package_bookings.all_bookings'))
                  action="{{ route('admin.package_bookings.all_bookings') }}"
                @elseif (request()->routeIs('admin.package_bookings.paid_bookings'))
                  action="{{ route('admin.package_bookings.paid_bookings') }}"
                @elseif (request()->routeIs('admin.package_bookings.unpaid_bookings'))
                  action="{{ route('admin.package_bookings.unpaid_bookings') }}"
                @endif method="GET"
              >
