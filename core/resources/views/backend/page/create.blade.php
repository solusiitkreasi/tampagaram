                                       ...
                                       <div class="row">
                                           <div class="col-lg-12">
                                               <div class="form-group">
                                                   ...
                                                   <input type="text" class="form-control {{$language->direction == 1 ? 'rtl' : ''}}" name="{{$language->code}}_name" value="" placeholder="Enter name">
                                               </div>
                                           </div>
                                       </div>
                                       ...
                                       <div class="row">
                                           <div class="col-lg-12">
                                               <div class="form-group {{$language->direction == 1 ? 'rtl text-right' : ''}}">
                                                   ...
                                                   <textarea class="form-control summernote" name="{{$language->code}}_body" placeholder="Enter body" data-height="300"></textarea>
                                               </div>
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="col-lg-12">
                                               <div class="form-group {{$language->direction == 1 ? 'rtl text-right' : ''}}">
                                                   ...
                                                   <input class="form-control" name="{{$language->code}}_meta_keywords" value="" placeholder="Enter meta keywords" data-role="tagsinput">
                                               </div>
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="col-lg-12">
                                               <div class="form-group">
                                                   ...
                                                   <textarea class="form-control {{$language->direction == 1 ? 'rtl text-right' : ''}}" name="{{$language->code}}_meta_description" rows="5" placeholder="Enter meta description"></textarea>
                                               </div>
                                           </div>
                                       </div>
