        ...
        <div class="card-body pt-5 pb-4">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form id="imageForm" action="{{ route('admin.basic_settings.update_breadcrumb') }}" method="POST">
                @csrf
                <div class="form-group">
                  <div class="thumb-preview" id="thumbPreview1">
                    @if (!empty($data->breadcrumb))
                    <img src="{{ asset('assets/img/' . $data->breadcrumb) }}" alt="breadcrumb">
                    @else
                  ...
                  <input type="hidden" id="fileInput1" name="breadcrumb">
                  <button 
                    id="chooseImage1" 
